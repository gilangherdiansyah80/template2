...
const AuthLayout = ({ children }) => {
  ...
  return (
    <div className="w-full bg-baseColor1">
      <header
        className="bg-baseColor2 top-0 left-0 w-full xl:flex xl:justify-center font-inter fixed z-30 h-24 md:h-20"
        data-aos="fade-down"
      >
        <div className="w-full xl:w-3/5 h-full flex justify-center xl:justify-between items-center">
          <div className="w-full flex justify-between xl:justify-start items-center">
            ...
            <div className="mr-3 lg:hidden">
              {open ? (
                <Icon
                  style="fas fa-times text-2xl mr-2 cursor-pointer text-baseColor4"
                  handleIcon={handleToggle}
                ></Icon>
              ) : (
                <Icon
                  style="fas fa-bars text-2xl mr-2 cursor-pointer text-baseColor4"
                  handleIcon={handleToggle}
                ></Icon>
              )}
            </div>
            ...
            <nav className="bg-baseColor4 w-full mt-72 md:mt-96 absolute xl:hidden">
              <ul className="text-white flex flex-col font-bold md:text-xl">
                <a href="#home" onClick={(e) => handleClick("home", e)}>
                  <li className="hover:bg-baseColor1 hover:text-baseColor4 w-full p-2 md:p-4 px-4">
                    Home
                  </li>
                </a>
          ...
          <nav className="hidden w-full lg:block">
            <ul className="text-baseColor4 flex font-bold justify-center items-center gap-x-3">
              ...
              >
                <li className="hover:scale-125 duration-300 rounded-lg p-3">
                  Home
                </li>
              </a>
              <a
