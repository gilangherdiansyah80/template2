  ...
  return (
      <Fragment>
            <section className='flex flex-col justify-center items-center p-5 gap-y-5 bg-gradient-to-l from-baseColor1 via-baseColor1 to-baseColor2' id='home'>
              <div className='lg:w-3/5 lg:self-center mt-28 lg:flex lg:gap-x-5 mb-12'>
                  <section className='w-full flex flex-col gap-y-3 lg:w-1/2'>
                    <img src="/images/tech1.jpg" alt="Apex Tech Solutions" className='w-full h-64 lg:h-80 rounded-xl' />
                  ...
                  <article className='flex flex-col gap-y-5 lg:w-1/2 lg:self-center lg:gap-y-10'>
                    <h1 className='font-bold text-3xl w-5/6 lg:text-5xl'>Selamat Datang di Apex Tech Solutions</h1>
            ...
            <section className='p-5 w-full flex flex-col lg:flex-row lg:gap-x-8 gap-y-8 lg:w-3/5 lg:self-center'>
              ...
              <article className='w-full'>
                <div className='flex flex-col gap-y-5'>
                  <div className='flex flex-col gap-y-3'>
                    <img src="/images/tech5.jpg" alt="Apex Tech Solutions" className='rounded-xl lg:h-[500px]' />
            ...
            <section>
              <section className='bg-baseColor2 lg:text-center flex justify-center items-center'>
                <article className='p-5 flex flex-col w-full md:h-fit gap-y-5 lg:w-3/5 lg:self-center'>
              ...
              <section className='bg-baseColor4 p-3 flex flex-col w-full gap-y-5 text-white'>
                <section className='flex flex-col gap-y-5 lg:w-3/5 lg:self-center lg:text-center'>
                  <article className='lg:self-center'>
                    <h2 className='w-80 text-2xl lg:w-full md:text-4xl font-semibold lg:text-center' data-aos="fade-down" data-aos-duration="1000" data-aos-delay="180">Solusi Canggih untuk Tantangan Kompleks</h2>
                  </article>
                ...
                <section className="flex flex-col gap-y-3 md:grid md:grid-cols-2 md:gap-5 w-full lg:w-3/5 lg:self-center mb-12">
